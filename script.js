...
window.realMoviesDatabase = [
    { title: "Tôi Muốn Ly Hôn Với Đại Lão", img: "https://i.postimg.cc/0QyDqkx0/69AACA28-C240-441A-84EC-3F04FDFDDA96.jpg", tag: "NEW", desc: "Vừa ra mắt" },
    { title: "Hoa Khôi Đã Có Em Bé", img: "https://i.postimg.cc/N0WZjw82/AD04FE19-D35B-4A4E-A3DE-357D0DA452DE.jpg", tag: "NEW", desc: "Vừa ra mắt" },
    { title: "Điều Bí Ẩn Trong Truyền Thuyết", img: "https://i.postimg.cc/zf94G1wG/gen.jpg", tag: "NEW", desc: "Vừa ra mắt" },
    { title: "Bạn Gái Gửi Nhờ Con Gái", img: "https://i.postimg.cc/fLRQ1f9y/7FDE2678-506D-4184-BEED-A353F46768D6.jpg", tag: "NEW", desc: "Vừa ra mắt" },
    { title: "Vợ Của Tôi Mắc Bệnh", img: "https://i.postimg.cc/7LVyBWf7/gen.jpg", tag: "NEW", desc: "Vừa ra mắt" },
    { title: "Tôi Từ Bỏ Chị Mình", img: "https://i.postimg.cc/g2KZwWD7/810E7C4C-7B02-41A1-B161-24547A2AEAB9.jpg", tag: "NEW", desc: "Vừa ra mắt" },
    { title: "Bạn Gái Là Do Tôi Nhặt Được", img: "https://i.postimg.cc/V6M5xw31/gen.jpg", tag: "NEW", desc: "Vừa ra mắt" },
    { title: "Tôi Được Đưa Đến Cạnh Em", img: "https://i.postimg.cc/RFT72kJQ/gen.jpg", tag: "NEW", desc: "Vừa ra mắt" },
    { title: "Cứu Được Hoa Khôi Trường", img: "https://i.postimg.cc/8cPRGZLf/gen.jpg", tag: "NEW", desc: "Vừa ra mắt" },
    { title: "Đồ Quý Giá Của Tiểu Thư", img: "https://i.postimg.cc/CdpzJpyp/gen.jpg", tag: "NEW", desc: "Vừa ra mắt" },
    { title: "Bám Lấy Bạn Gái Xã Hội", img: "https://i.postimg.cc/pdBNLxc7/IMG-1655.jpg", tag: "NEW", desc: "Vừa ra mắt" },
    { title: "Mẹ Tìm Người Dám Sát Tôi", img: "https://i.postimg.cc/fbv4RZqp/gen.jpg", tag: "NEW", desc: "Vừa ra mắt" },
    { title: "Đại Tiểu Thư Không Yêu Tôi", img: "https://i.postimg.cc/KYMq1Xgy/gen.jpg", tag: "NEW", desc: "Vừa ra mắt" },
    { title: "Bố Giúp Tôi Lấy Con Gái Của Bạn", img: "https://i.postimg.cc/MGQPnkjJ/gen.jpg", tag: "NEW", desc: "Vừa ra mắt" },
    { title: "Hoa Khôi Quá Bám Tôi", img: "https://i.postimg.cc/MGQPnkj2/gen.jpg", tag: "NEW", desc: "Vừa ra mắt" },
    { title: "Tôi Kéo Được Tình Yêu Nhưng", img: "https://i.postimg.cc/7LNWXzDP/gen.jpg", tag: "NEW", desc: "Vừa ra mắt" },
...
window.openPlayer = function(movieName) {
    ...
    let audioLink = "";
    if (movieName.includes('Tôi Muốn Ly Hôn Với Đại Lão')) audioLink = "https://videotourl.com/audio/1779084153863-f905c9c5-f0bb-4132-8ceb-974803019aeb.m4a";
    else if (movieName.includes('Hoa Khôi Đã Có Em Bé')) audioLink = "https://videotourl.com/audio/1779002003624-511d1962-2a5f-4662-8950-4727cecf00cb.m4a";
    else if (movieName.includes('Điều Bí Ẩn Trong Truyền Thuyết')) audioLink = "https://videotourl.com/audio/1779001858015-891b7581-070f-446e-aa3a-d2a5b2ea4d0c.m4a";
    else if (movieName.includes('Bạn Gái Gửi Nhờ Con Gái')) audioLink = "https://videotourl.com/audio/1778912532488-dbd61604-387a-4da9-ab25-2abec9ea9072.m4a";
    else if (movieName.includes('Vợ Của Tôi Mắc Bệnh')) audioLink = "https://videotourl.com/audio/1778912384799-73c55bde-b0f0-4bcd-9ac0-d3fc0170c138.m4a";
    else if (movieName.includes('Tôi Từ Bỏ Chị Mình')) audioLink = "https://videotourl.com/audio/1778820581886-8c11a88b-7f40-48c8-9b0c-93ddb7b8e7a8.m4a";
    else if (movieName.includes('Bạn Gái Là Do Tôi Nhặt Được')) audioLink = "https://videotourl.com/audio/1778755421125-a8562e4e-e9ec-4e1d-9d76-34eb31461ff5.m4a";
    else if (movieName.includes('Tôi Được Đưa Đến Cạnh Em')) audioLink = "https://videotourl.com/audio/1778683416286-6590e204-2ae2-45a9-9593-0baf5e08fce9.m4a";
    else if (movieName.includes('Cứu Được Hoa Khôi Trường')) audioLink = "https://videotourl.com/audio/1778682831898-ac1e91a5-eac9-4bbb-b47d-dee171cfd1fb.m4a";
    else if (movieName.includes('Đồ Quý Giá Của Tiểu Thư')) audioLink = "https://videotourl.com/audio/1778610249666-9aa58abd-fb64-4067-a0db-7fd57bc8f583.m4a";
    else if (movieName.includes('Bám Lấy Bạn Gái Xã Hội')) audioLink = "https://videotourl.com/audio/1778456245230-085a9567-3bdb-4901-aabc-38a7c8620408.m4a";
    else if (movieName.includes('Mẹ Tìm Người Dám Sát Tôi')) audioLink = "https://videotourl.com/audio/1778453856812-c4382dfb-9aa7-4c6a-bcea-099753158e25.m4a";
    else if (movieName.includes('Đại Tiểu Thư Không Yêu Tôi')) audioLink = "https://videotourl.com/audio/1778257761898-f7cee7e2-d150-4b17-9e9c-5b703659ebd6.m4a";
    else if (movieName.includes('Bố Giúp Tôi Lấy Con Gái Của Bạn')) audioLink = "https://videotourl.com/audio/1778257518578-f16225e8-48f0-4f7f-9d5a-a959eeabe872.m4a";
    else if (movieName.includes('Hoa Khôi Quá Bám Tôi')) audioLink = "https://videotourl.com/audio/1778257224492-46d0d8a5-cdf5-44d1-97a3-32bb4ad85e87.m4a";
    else if (movieName.includes('Tôi Kéo Được Tình Yêu Nhưng')) audioLink = "https://videotourl.com/audio/1777909664228-752aa7b4-f35c-40af-83ea-8c71887e5482.m4a";
    else if (movieName.includes('Mập Mờ Với Con Thầy Giáo')) audioLink = "https://videotourl.com/audio/1777829654952-31035f14-1573-4de6-b998-4609f1d0387c.m4a";
